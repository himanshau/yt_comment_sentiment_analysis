...
def load_params(params_path: str) -> dict:
    ...
    - Tries to open and read the YAML file
    - Handles potential errors (FileNotFound, YAML parsing errors)
...
def load_data(file_path: str) -> pd.DataFrame:
    ...
    - Fills any NaN values with empty strings
...
def apply_tfidf(train_data: pd.DataFrame, max_features: int, ngram_range: tuple) -> tuple:
    ...
    - Creates TF-IDF vectorizer with specified parameters
    - Transforms text data into numerical features
    - Saves the vectorizer for later use
    - Returns transformed features and labels
    """
    try:
